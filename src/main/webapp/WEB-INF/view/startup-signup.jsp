...
<html lang="en">
<head>
    <title>Create Startup Account | EcoTrack</title>
    <meta charset="UTF-8">
...
<div class="signup-card">
    ...
    <p class="subtitle">Register your startup and connect with investors.</p>

    <form action="/completeStartupSignup" method="post" onsubmit="return validateForm()">
            ...
            <div class="grid">
                ...
                <div>
                    ...
                    <input type="text" name="companyName"
                           placeholder="Your Startup Pvt Ltd" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="registrationNumber"
                           placeholder="CIN / GST / Govt Registration No." required>
                </div>

                <div>
                    <label>Government ID</label>
                    <input type="text" name="governmentId"
                           placeholder="PAN / GST / Official ID" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="fundingAsk"
                           placeholder="500000"
                ...
                <div>
                    ...
                    <input type="number" name="equityOffered"
                           placeholder="10"
                ...
                <div style="grid-column:1/-1">
                    ...
                    <textarea name="description"
                              placeholder="Briefly describe your product, problem solved, traction, and target market..."
                              required></textarea>
                </div>
