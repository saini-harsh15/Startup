...
<div id="msSidebar" class="ms-sidebar">
  <div class="panel">
    ...
    <a href="/startup/dashboard/${startup.id}"><i class="fas fa-th-large"></i> Dashboard</a>
        ...
        <div class="chat-list">
            ...
            <div class="search-container">
                <form id="searchForm" action="/startup/messages" method="GET">
                    <input id="searchInput" type="search" name="search" placeholder="Search investor name or domain..."
                    ...
                    <c:when test="${not empty investorsList}">
                        <c:forEach var="investor" items="${investorsList}">
                            <div id="partner${investor.id}"
                                 class="chat-item"
                                 data-name="${investor.investorName}"
...
<script>
    ...
    function connect() {
        ...
        stompClient.connect({}, function (frame) {
            ...
            stompClient.subscribe('/topic/typing/' + currentStartupId, function (message) {
        ...
        fetch(url, { method: 'GET' })
            ...
            .then(messages => {
                ...
                if (!messages || messages.length === 0) {
                    ...
                    p.textContent = 'No messages yet. Start the conversation with ' + investorName + '.';
                    p.id = 'initialPrompt';
    ...
    function sendTyping(state){
        ...
        const payload = { from: currentStartupId, to: currentReceiverId, typing: !!state };
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (attachBtn && fileInput){
            ...
            fileInput.addEventListener('change', async function(){
                ...
                if (!currentReceiverId){ alert('Please select an investor first.'); fileInput.value=''; return; }
                ...
                try{
                    ...
                    if (!resp.ok){
                        ...
                        const chatMessage = { senderId: currentStartupId, receiverId: currentReceiverId, content };
                        stompClient.send('/app/chat', {}, JSON.stringify(chatMessage));
                    }
                }catch(err){
                    console.error(err);
